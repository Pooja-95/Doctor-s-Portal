...
<!--           <input type="text" name="search" class="form-control" placeholder="Search doctor">-->
   ...
   <div class="form-group">
            ...
            <select  name="insurance" class="form-control" >
                ...
                <option value="Auto-Owners Insurance">Auto-Owners Insurance</option>
                <option value="Medical genetics">Erie Insurance</option>
                <option value="Dermatology">USAA</option>
                <option value="Diagnostic">Amica Mutual</option>
                <option value="Emergency medicine">Auto Club of Southern California Insurance Group</option>
                <option value="Family medicine">FEsurance</option>
                <option value="Internal medicine">Safeco</option>
            
            </select></div>

<button id="show2" class="btn btn-primary">search</button>
<style>
dialog{width:400px;}
</style>
<dialog id="dialog2">
...
String sql ="select * from doctorregister where (active=1 and country='"+country+"' AND specialization='"+specialization+"' AND insurance='"+insurance+"') OR (active=1 and country='"+country+"' AND specialization='"+specialization+"') OR (active=1 and country='"+country+"' AND insurance='"+insurance+"') OR (active=1 and specialization='"+specialization+"' AND insurance='"+insurance+"' ) OR (active=1 and country='"+country+"') OR (active=1 and specialization='"+specialization+"' ) OR (active=1 and insurance='"+insurance+"') ";
...
%>
<form action="doctordetail.jsp">
<div class="col-sm-4">
<!--    <div style="border: 1px solid; float:left; ">-->
<img src="<%=resultSet.getString("image") %>"><br>
<%=resultSet.getString("fname") %><br>
<%=resultSet.getString("lname") %><br>
<%=resultSet.getString("email") %><br>
<%=resultSet.getString("country") %><br>
<!--    </div>-->
...
<input type="hidden" name="country" value="<%=resultSet.getString("country") %>">
