...
<%
    ...
    final String messg = "http://localhost:8080/DoctorPortal/passworddoctor.jsp?email="+to;
    
    
    PreparedStatement pst=connection.prepareStatement("update doctorregister set active=1 where email='"+to+"'");
    pst.executeUpdate();
