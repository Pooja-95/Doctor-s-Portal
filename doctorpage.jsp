...
String sql ="select * from doctorregister where email='"+em+"'and password='"+pass+"'";
...
div {
  ...
  padding-left: 10px;
            ...
            <%
//                String str="doctordata"+"/" +em+ "/" + resultSet.getString("image");
//                out.println(str);
            %>
		...
		<div class="col-md-6 col-lg-3 ftco-animate">
			...
			<div class="img-wrap d-flex align-items-stretch">
				<div class="img align-self-stretch" style="background-image: url(<%= "doctordata/pooja/new.png"%>);"></div>
	</div>
...
<div class="form-group">
        <h6> Mobile Number </h6>
        <input type="number" class="form-control" name="phone" value="<%=resultSet.getString("phone")%>" required autocomplete="off"><br>
</div>
<div class="form-group">
        <h6> Address </h6>
...
<div class="form-group">
        <h6> Image </h6>
        <input type="text" class="form-control" name="image" value="<%=resultSet.getString("image")%>" required autocomplete="off"><br>
</div>
...
<%
statement=connection.createStatement();
String sql1 ="select * from appointment where doctoremail='"+em+"'";
...
while(resultSet1.next())
{
 ...
 <tr>         
                                ...
                                <td><input type="time" value="<%= resultSet1.getString(4) %>" name="time"></td>
                                <td><input type="date" value="<%= resultSet1.getString(5) %>" name="date"></td>
                                <% if(Integer.parseInt(resultSet1.getString(6)) == 0)
                                 {
                                 %>
                                 <td><a href="varifryappintment.jsp?email=<%= resultSet1.getString(3)%>&&time=<%= resultSet1.getString(4)%>&&date=<%= resultSet1.getString(5)%>&&aid=<%= resultSet1.getString(1)%>"class="btn btn-primary">Accept Request</a> </td>
                                 <td><a href="mail2.jsp?email=<%= resultSet1.getString(3) %>"class="btn btn-primary">Reject Request</a> </td>
<%}%>
 </tr>
<%                               
}
